...
export interface FieldGroupNode extends TemplateNodeBase {
  type: "fieldGroup";
  fields: TemplateField[];
}
export interface CollectionNode extends TemplateNodeBase {
  type: "collection";
  repeatable: true;
  items: FieldGroupNode[];
  prototypeId: string;
  minItems?: number;
  maxItems?: number;
}
export interface ImageNode extends TemplateNodeBase {
  type: "image";
  description?: string;
...
export type TemplateNode =
  ContainerNode | TextNode | ListNode | FieldGroupNode | CollectionNode | ImageNode;
