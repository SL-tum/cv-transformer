...
export interface PictureNode extends BaseNode<"picture"> {
  resourceId: string;
  transform: Transform;
  crop?: Crop;
  effects?: Record<string, unknown>;
...
export interface GroupNode extends BaseNode<"group"> {
  transform: Transform;
  elements: GraphicNode[];
}
export interface ConnectorNode extends BaseNode<"connector"> {
  transform: Transform;
  startRef?: string;
  endRef?: string;
  line?: LineStyle;
...
export interface DiagramNode extends BaseNode<"diagram"> {
  resourceId: string;
  transform: Transform;
}
export interface GraphicFrameNode extends BaseNode<"graphicFrame"> {
  transform: Transform;
  contentType: string;
  resourceId?: string;
}
export type GraphicNode =
  ShapeNode | PictureNode | GroupNode | ConnectorNode | ChartNode | DiagramNode | GraphicFrameNode;
